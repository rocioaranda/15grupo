...
<div class="container-fluid py-5 text-white" style="background-color: #0d0f12; min-height: 90vh;">
    <div class="container">
        ...
        <div class="card bg-dark text-white border-0 shadow-lg p-4">
            <h4 class="fw-bold mb-4 text-success border-bottom border-secondary pb-2 small-header">Acciones de Administración</h4>
            <div class="d-flex flex-wrap gap-3">
                <button class="btn btn-success fw-bold px-4 shadow-none">
                    <i class="bi bi-plus-circle me-2"></i> Agregar Nuevo Producto
                </button>
                <button class="btn btn-outline-light border-secondary fw-bold px-4 shadow-none">
                    <i class="bi bi-list-stars me-2"></i> Ver Órdenes de Compra
                </button>
            </div>
        </div>
    </div>
