<footer>
    <div class="bg-black text-white py-5 border-top border-success">
        <div class="row"> 
            <div class="col-md-6 text-center mb-4 mb-md-0">
                <h5 class="text-success fw-bold mb-3">Categorías</h5>
                ...
                <h5 class="text-success fw-bold mb-3">Contáctanos</h5>
                 <ul class="list-unstyled">
                    <li class="mb-2 text-white">
                        <i class="bi bi-whatsapp text-success me-2"></i> 541124096668
                    </li>
                    <li class="mb-2 text-white">
                    <i class="bi bi-instagram text-success me-2"></i><i class="bi bi-facebook text-success me-2"></i>Evolvex Suplementos
                    </li>
                    <li class="mb-2 text-white">
                    <i class="bi bi-envelope text-success me-2"></i> evolvex_suplementos@gmail.com
                    </li>
                  <li class="mb-2 text-white">
                      <i class="bi bi-geo-alt text-success me-2"></i> Muñiz 1900, Buenos Aires, Argentina
                </li>
              </ul>
        </div>
    </div>     
